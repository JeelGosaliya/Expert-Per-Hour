...
<div class="container">
	...
	<div class="sixteen columns">
			...
			<tr>
				<th><i class="fa fa-file-text"></i>Package ID</th>
				<th><i class="fa fa-file-text"></i>Package Title</th>
                                <th><i class="fa fa-file-text"></i>Package Description</th>
                                <th><i class="fa fa-file-text"></i>Package Price</th>
                                <th><i class="fa fa-file-text"></i>Package Duration</th>
		...
		<!-- Item #1 -->
                            ...
                            {
                                $delete = $_GET['delete'];
                                $dq = mysql_query("delete from Package_tbl where Package_Id ='{$delete}'") or die(mysql_error());
                                echo "<script>alert('Record Deleted');</script>";
                            }           
                                    $q=  mysql_query("select * from Package_tbl") or die(mysql_error());
		...
		<br>
                <a href="Package_tbl.php" class="button">Insert</a>               
	</div>
</div>
