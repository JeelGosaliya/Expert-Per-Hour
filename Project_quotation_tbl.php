...
if($_POST)
{
    ...
    $q = mysql_query("insert into Project_quotation_tbl (Quotation_Date,Quotation_Description,Quotation_Amount,Quotation_SDate,Quotation_EDate) values ('{$date}','{$dec}','{$amount}','{$sdate}','{$edate}')") or die(mysql_error());
		...
		<div class="submit-page">
			...
			<div class="form">
				...
				<h5>Quotation Amount</h5>
                                <input class="search-field" type="text" placeholder="Enter Amount" name="txt3" required="true"/>
			</div>
                        <div class="form">
				<h5>Quotation Starting Date</h5>
                                <input class="search-field" type="date" placeholder="Enter Staring Date" name="txt4" required="true"/>
			</div>
                        <div class="form">
				<h5>Quotation Ending Date</h5>
                                <input class="search-field" type="date" placeholder="Enter Ending Date" name="txt5" required="true"/>
			</div>
                        <div class="form">
				<h5>Status Id</h5>
				...
				<h5>Project Id</h5>
                        ...
                        <input class="button big margin-top-5" type="submit" value="Insert">
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input class="button big margin-top-5" type="button"  onclick="window.location='Project_quotation_dd.php';" value="Display">
                    </form>
		</div>
	</div>
            </div>
