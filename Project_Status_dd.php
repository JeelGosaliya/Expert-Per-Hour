...
<div class="container">
	...
	<div class="sixteen columns">
			...
			<tr>
				<th><i class="fa fa-file-text"></i>Project Status ID</th>
				<th><i class="fa fa-file-text"></i>Status Date</th>
		...
		<!-- Item #1 -->
                            ...
                            {
                                $delete = $_GET['delete'];
                                $dq = mysql_query("delete from Project_Status_tbl where Project_Status_Id ='{$delete}'") or die(mysql_error());
                                echo "<script>alert('Record Deleted');</script>";
                            }           
                                    $q=  mysql_query("select * from Project_Status_tbl") or die(mysql_error());
		...
		<br>
                <a href="Project_Status_tbl.php" class="button">Insert</a>               
	</div>
</div>
