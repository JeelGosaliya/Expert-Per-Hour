...
<div id="titlebar" class="single">
	<div class="container">
		...
		<div class="sixteen columns">
			<h2>Manage Expert Technology</h2>
			<nav id="breadcrumbs">
...
<div class="container">
	...
	<div class="sixteen columns">
			...
			<tr>
				<th><i class="fa fa-file-text"></i>Expert Technology ID</th>
				<th><i class="fa fa-file-text"></i>Expert Technology Name</th>
                                <th><i class="fa fa-file-text"></i>Hourly Rate</th>
		...
		<!-- Item #1 -->
                            ...
                            {
                                $delete = $_GET['delete'];
                                $dq = mysql_query("delete from Expert_Technology_tbl where Expert_Technology_Id ='{$delete}'") or die(mysql_error());
                                echo "<script>alert('Record Deleted');</script>";
                            }           
                                    $q=  mysql_query("select * from Expert_Technology_tbl") or die(mysql_error());
		...
		<br>
                <a href="Expert_Technology_tbl.php" class="button">Insert</a>               
	</div>
</div>
