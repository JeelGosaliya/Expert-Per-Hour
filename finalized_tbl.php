		...
		<div class="submit-page">
			...
			<div class="form">
				...
				<h5>Package Id</h5>
                        ...
                        <div class="form">
				<h5>QuotationId</h5>
                                <select class="search-field" name="qout">
                                    <?php 
                                    $dq = mysql_query("select * from project_quotation_tbl") or die(mysql_error());
                                    while($drdata = mysql_fetch_row($dq))
                                    {
                                        echo "<option value='$drdata[0]'>$drdata[1]</option>";
                                    }
				...
				<h5>User Type Id</h5>
                        ...
                        <div class="form">
				<h5>Extended Charges Id</h5>
                                <select class="search-field" name="charges">
                                    <?php 
                                    $dq = mysql_query("select * from extended_charges_tbl") or die(mysql_error());
                                    while($drdata = mysql_fetch_row($dq))
                                    {
                                        echo "<option value='$drdata[0]'>$drdata[1]</option>";
                                    }
