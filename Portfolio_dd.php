...
<div class="container">
	...
	<div class="sixteen columns">
			...
			<tr>
				<th><i class="fa fa-file-text"></i>Portfolio ID</th>
				<th><i class="fa fa-file-text"></i>Portfolio URL</th>
                                <th><i class="fa fa-file-text"></i>Portfolio Title</th>
                                <th><i class="fa fa-file-text"></i>Portfolio Description</th>
		...
		<!-- Item #1 -->
                            ...
                            {
                                $delete = $_GET['delete'];
                                $dq = mysql_query("delete from Portfolio_tbl where Portfolio_Id ='{$delete}'") or die(mysql_error());
                                echo "<script>alert('Record Deleted');</script>";
                            }           
                                    $q=  mysql_query("select * from Portfolio_tbl") or die(mysql_error());
                                    
                                        while($data=  mysql_fetch_row($q))
                                        {
                                                echo "<tr>";
                                                echo "<td>$data[0]</td>";
                                                echo "<td><a href='portimg/$data[1]' target='_blank'><img src='portimg/$data[1]' style='width:50px;'></a></td>";
                                                echo "<td>$data[2]</td>";
                                                echo "<td>$data[3]</td>";
		...
		<br>
                <a href="Portfolio_tbl.php" class="button">Insert</a>               
	</div>
</div>
