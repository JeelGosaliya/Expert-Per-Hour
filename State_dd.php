...
<div class="container">
	...
	<div class="sixteen columns">
			...
			<tr>
				<th><i class="fa fa-file-text"></i>State ID</th>
				<th><i class="fa fa-file-text"></i>State Name</th>
		...
		<!-- Item #1 -->
                            ...
                            {
                                $delete = $_GET['delete'];
                                $dq = mysql_query("delete from Review_tbl where State_Id ='{$delete}'") or die(mysql_error());
                                echo "<script>alert('Record Deleted');</script>";
                            }           
                                    $q=  mysql_query("select * from State_tbl") or die(mysql_error());
		...
		<br>
                <a href="State_tbl.php" class="button">Insert</a>               
	</div>
</div>
