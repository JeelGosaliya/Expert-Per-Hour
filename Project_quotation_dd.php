...
<div id="titlebar" class="single">
	<div class="container">
		...
		<div class="sixteen columns">
			<h2>Manage Project Quotations</h2>
			<nav id="breadcrumbs">
...
<div class="container">
	...
	<div class="sixteen columns">
			...
			<tr>
				<th><i class="fa fa-file-text"></i>Quotation ID</th>
				<th><i class="fa fa-file-text"></i>Quotation Date</th>
                                <th><i class="fa fa-file-text"></i>Description</th>
                                <th><i class="fa fa-file-text"></i>Quotation Amount</th>
                                <th><i class="fa fa-file-text"></i>Starting Date</th>
                                <th><i class="fa fa-file-text"></i>Ending Date</th>
		...
		<!-- Item #1 -->
                            ...
                            {
                                $delete = $_GET['delete'];
                                $dq = mysql_query("delete from Project_quotation_tbl where Project_quotation_Id ='{$delete}'") or die(mysql_error());
                                echo "<script>alert('Record Deleted');</script>";
                            }           
                                    $q=  mysql_query("select * from Project_quotation_tbl") or die(mysql_error());
		...
		<br>
                <a href="Project_quotation_tbl.php" class="button">Insert</a>               
	</div>
</div>
