...
<div class="container">
	...
	<div class="sixteen columns">
			...
			<tr>
				<th><i class="fa fa-file-text"></i>Project ID</th>
				<th><i class="fa fa-file-text"></i>Project Title<th>
                                <th><i class="fa fa-file-text"></i>Project Description</th>
                                <th><i class="fa fa-file-text"></i>Project Budget</th>
                                <th><i class="fa fa-file-text"></i>Project Duration</th>
		...
		<!-- Item #1 -->
                            ...
                            {
                                $delete = $_GET['delete'];
                                $dq = mysql_query("delete from Project_tbl where Project_Id ='{$delete}'") or die(mysql_error());
                                echo "<script>alert('Record Deleted');</script>";
                            }           
                                    $q=  mysql_query("select * from Project_tbl") or die(mysql_error());
		...
		<br>
                <a href="Project_tbl.php" class="button">Insert</a>               
	</div>
</div>
