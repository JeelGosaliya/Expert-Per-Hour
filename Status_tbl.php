...
if($_POST)
{
    ...
    $q = mysql_query("insert into Status_tbl (Status_Name) values ('{$name}')") or die(mysql_error());
...
<div class="container">
	...
	<div class="ten columns">
		<div class="submit-page">
			...
			<div class="form">
				<h5>Status's Name</h5>
                                <input class="search-field" type="text" placeholder="Enter Your Status's Name" name="txt1" required="true"/>
			</div>
		 	...
		 	<div class="divider margin-top-0"></div>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input class="button big margin-top-5" type="button"  onclick="window.location='Status_dd.php';" value="Display">
                    </form>
		</div>
	</div>
