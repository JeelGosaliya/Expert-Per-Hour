...
if($_POST)
{
    ...
    $q = mysql_query("insert into Technology_tbl (Technology_Name) values ('{$name}')") or die(mysql_error());
		...
		<div class="submit-page">
			...
			<div class="form">
				<h5>Technology Name</h5>
                                <input class="search-field" type="text" placeholder="Select Technology" name="txt1" required="true"/>
			</div>
		 	<div class="divider margin-top-0"></div>
                        <input class="button big margin-top-5" type="submit" value="Insert">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input class="button big margin-top-5" type="button"  onclick="window.location='Technology_dd.php';" value="Display">
		</div>
	</div>
            </div>
        </div>
