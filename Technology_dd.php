...
<div class="container">
	...
	<div class="sixteen columns">
			...
			<tr>
				<th><i class="fa fa-file-text"></i>Technology ID</th>
				<th><i class="fa fa-file-text"></i>Technology Name</th>
		...
		<!-- Item #1 -->
                            ...
                            {
                                $delete = $_GET['delete'];
                                $dq = mysql_query("delete from Technology_tbl where Technology_Id ='{$delete}'") or die(mysql_error());
                                echo "<script>alert('Record Deleted');</script>";
                            }           
                                    $q=  mysql_query("select * from Technology_tbl") or die(mysql_error());
		...
		<br>
                <a href="Technology_tbl.php" class="button">Insert</a>               
	</div>
</div>
