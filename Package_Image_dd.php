...
<div class="container">
	...
	<div class="sixteen columns">
			...
			<tr>
				<th><i class="fa fa-file-text"></i>Package Image ID</th>
				<th><i class="fa fa-file-text"></i>Image Path</th>
		...
		<!-- Item #1 -->
                            ...
                            {
                                $delete = $_GET['delete'];
                                $dq = mysql_query("delete from Package_Image_tbl where Package_Image_Id ='{$delete}'") or die(mysql_error());
                                echo "<script>alert('Record Deleted');</script>";
                            }           
                                    $q=  mysql_query("select * from Package_Image_tbl") or die(mysql_error());
		...
		<br>
                <a href="Package_Image_tbl.php" class="button">Insert</a>               
	</div>
</div>
