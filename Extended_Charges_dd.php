...
<div class="container">
	...
	<div class="sixteen columns">
			...
			<tr>
				<th><i class="fa fa-file-text"></i>Extended Charges ID</th>
				<th><i class="fa fa-file-text"></i>Extended Charges Duration</th>
                                <th><i class="fa fa-file-text"></i>Extended Charges</th>
		...
		<!-- Item #1 -->
                            ...
                            {
                                $delete = $_GET['delete'];
                                $dq = mysql_query("delete from Extended_Charges_tbl where Extended_Charges_Id ='{$delete}'") or die(mysql_error());
                                echo "<script>alert('Record Deleted');</script>";
                            }           
                                    $q=  mysql_query("select * from Extended_Charges_tbl") or die(mysql_error());
		...
		<br>
                <a href="Extended_Charges_tbl.php" class="button">Insert</a>               
	</div>
</div>
