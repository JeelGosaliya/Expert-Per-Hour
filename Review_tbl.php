...
if($_POST)
{
    ...
    $q = mysql_query("insert into Review_tbl (Review_Date,Review_Description) values ('{$date}','{$des}')") or die(mysql_error());
			...
			<div class="form">
		 	...
		 	<div class="divider margin-top-0"></div>
                        ...
                        <input class="button big margin-top-5" type="submit" value="Insert">
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input class="button big margin-top-5" type="button"  onclick="window.location='Review_dd.php';" value="Display">
                    </form>
		</div>
	</div>
