...
if($_POST)
{
    ...
    $q = mysql_query("insert into User_Type_tbl (User_Type_Name) values ('{$name}')") or die(mysql_error());
		...
		<div class="submit-page">
			...
			<div class="form">
				<h5>User Type Name</h5>
                                <input class="search-field" type="text" placeholder="Enter User Type's Name" name="txt1" required="true"/>
			</div>
		 	...
		 	<div class="divider margin-top-0"></div>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input class="button big margin-top-5" type="button"  onclick="window.location='User_Type_dd.php';" value="Display">
                    </form>
		</div>
	</div>
