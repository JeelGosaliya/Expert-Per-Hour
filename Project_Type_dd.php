...
<div class="container">
	...
	<div class="sixteen columns">
			...
			<tr>
				<th><i class="fa fa-file-text"></i>Project Type ID</th>
				<th><i class="fa fa-file-text"></i>Project Type Name</th>
		...
		<!-- Item #1 -->
                            ...
                            {
                                $delete = $_GET['delete'];
                                $dq = mysql_query("delete from Project_Type_tbl where Project_Type_Id ='{$delete}'") or die(mysql_error());
                                echo "<script>alert('Record Deleted');</script>";
                            }           
                                    $q=  mysql_query("select * from Project_Type_tbl") or die(mysql_error());
		...
		<br>
                <a href="Project_Type_tbl.php" class="button">Insert</a>               
	</div>
</div>
