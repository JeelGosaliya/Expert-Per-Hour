...
<div class="container">
	...
	<div class="sixteen columns">
			...
			<tr>
				<th><i class="fa fa-file-text"></i>Review ID</th>
				<th><i class="fa fa-file-text"></i>Review Date</th>
                                <th><i class="fa fa-file-text"></i>Review Description</th>
		...
		<!-- Item #1 -->
                            ...
                            {
                                $delete = $_GET['delete'];
                                $dq = mysql_query("delete from Review_tbl where Review_Id ='{$delete}'") or die(mysql_error());
                                echo "<script>alert('Record Deleted');</script>";
                            }           
                                    $q=  mysql_query("select * from Review_tbl") or die(mysql_error());
		...
		<br>
                <a href="Review_tbl.php" class="button">Insert</a>               
	</div>
</div>
