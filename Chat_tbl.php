...
if($_POST)
{
    ...
    $q = mysql_query("insert into chat_tbl (Chat_Date,Chat_Desctiption) values ('{$date}','{$des}')") or die(mysql_error());
	...
	<div class="ten columns">
		<div class="submit-page">
			...
			<input class="button big margin-top-5" type="submit" value="Insert">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input class="button big margin-top-5" type="button"  onclick="window.location='Chat_dd.php';" value="Display">
                    </form>
		</div>
	</div>
