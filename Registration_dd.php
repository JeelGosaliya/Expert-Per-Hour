...
<div class="container">
	...
	<div class="sixteen columns">
			...
			<tr>
				<th><i class="fa fa-file-text"></i>Registration ID</th>
				<th><i class="fa fa-file-text"></i>First Name</th>
                                <th><i class="fa fa-file-text"></i>Last Name</th>
                                <th><i class="fa fa-file-text"></i>E-Mail ID</th>
                                <th><i class="fa fa-file-text"></i>Password</th>
		...
		<!-- Item #1 -->
                            ...
                            {
                                $delete = $_GET['delete'];
                                $dq = mysql_query("delete from Registration_tbl where Registration_Id ='{$delete}'") or die(mysql_error());
                                echo "<script>alert('Record Deleted');</script>";
                            }           
                                    $q=  mysql_query("select * from Registration_tbl") or die(mysql_error());
		...
		<br>
                <a href="Registration_tbl.php" class="button">Insert</a>               
	</div>
</div>
