...
if($_POST)
{
    ...
    $q = mysql_query("insert into Project_tbl (Project_Title,Project_Description,Project_Budget,Project_Duration) values ('{$title}','{$dec}','{$budget}','{$duration}')") or die(mysql_error());
...
<div class="container">
	...
	<div class="ten columns">
		<div class="submit-page">
			...
			<div class="form">
				<h5>Project Title</h5>
                                <input class="search-field" type="text" placeholder="Enter Title" name="txt1" required="true"/>
			</div>
                        <div class="form">
				...
				<h5>Project Budget</h5>
                                <input class="search-field" type="text" placeholder="Enter Budget's Value" name="txt3" required="true"/>
			</div>
                        <div class="form">
				<h5>Project Duration</h5>
                                <input class="search-field" type="text" placeholder="Enter Duration For The Project" name="txt4" required="true"/>
			</div>
                        <div class="form">
				...
				<h5>Project Type</h5>
                                ...
                                <select class="search-field" name="project_type">
                                    
                                    <?php 
                                    
                                    $dq = mysql_query("select * from project_type_tbl") or die(mysql_error());
				...
				<h5>Category</h5>
                                ...
                                <select class="search-field" name="category">
                                    ...
                                    $dq = mysql_query("select * from category_tbl") or die(mysql_error());
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input class="button big margin-top-5" type="button"  onclick="window.location='Project_dd.php';" value="Display">
                    </form>
		</div>
	</div>
            </div>
