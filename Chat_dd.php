...
<div class="container">
	...
	<div class="sixteen columns">
			...
			<tr>
				<th><i class="fa fa-file-text"></i>Chat ID</th>
				<th><i class="fa fa-file-text"></i>Chat Date</th>
                                <th><i class="fa fa-file-text"></i>Chat Description</th>
		...
		<!-- Item #1 -->
                            ...
                            {
                                $delete = $_GET['delete'];
                                $dq = mysql_query("delete from Chat_tbl where Chat_Id ='{$delete}'") or die(mysql_error());
                                echo "<script>alert('Record Deleted');</script>";
                            }            
                                    $q=  mysql_query("select * from Chat_tbl") or die(mysql_error());
		...
		<br>
                <a href="Chat_tbl.php" class="button">Insert</a>               
	</div>
</div>
