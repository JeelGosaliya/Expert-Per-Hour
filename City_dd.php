...
<div class="container">
	...
	<div class="sixteen columns">
			...
			<tr>
				<th><i class="fa fa-file-text"></i>City ID</th>
				<th><i class="fa fa-file-text"></i>City Name</th>
		...
		<!-- Item #1 -->
                            ...
                            {
                                $delete = $_GET['delete'];
                                $dq = mysql_query("delete from City_tbl where City_Id ='{$delete}'") or die(mysql_error());
                                echo "<script>alert('Record Deleted');</script>";
                            }            
                                    $q=  mysql_query("select * from City_tbl") or die(mysql_error());
		...
		<br>
                <a href="City_tbl.php" class="button">Insert</a>               
	</div>
</div>
