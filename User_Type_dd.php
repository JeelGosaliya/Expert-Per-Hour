...
<div class="container">
	...
	<div class="sixteen columns">
			...
			<tr>
				<th><i class="fa fa-file-text"></i>User Type ID</th>
				<th><i class="fa fa-file-text"></i>User Type Name</th>
		...
		<!-- Item #1 -->
                            ...
                            {
                                $delete = $_GET['delete'];
                                $dq = mysql_query("delete from User_Type_tbl where User_Type_Id ='{$delete}'") or die(mysql_error());
                                echo "<script>alert('Record Deleted');</script>";
                            }           
                                    $q=  mysql_query("select * from User_Type_tbl") or die(mysql_error());
		...
		<br>
                <a href="User_Type_tbl.php" class="button">Insert</a>               
	</div>
</div>
