...
if($_POST)
{
    ...
    $q = mysql_query("insert into State_tbl (State_Name) values ('{$name}')") or die(mysql_error());
...
<div class="container">
	...
	<div class="ten columns">
		<div class="submit-page">
			...
			<div class="form">
				<h5>State Name</h5>
                                <input class="search-field" type="text" placeholder="Enter Your State's Name" name="txt1" required="true"/>
			</div>
		 	<div class="divider margin-top-0"></div>
                        <input class="button big margin-top-5" type="submit" value="Insert">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input class="button big margin-top-5" type="button"  onclick="window.location='State_dd.php';" value="Display">
                    </form>
		</div>
	</div>
            </div>
